...
const Client = () => {
  return (
    <div className="theme-container mt-12 md:mt-24 mx-auto">
      <div className="flex items-center justify-center flex-col">
        <h2 className="text-center md:text-start text-xl md:text-4xl font-semibold">
          Trusted more than <span className="text-[#F88C3D]">100+</span> in the
          world
        </h2>
        <p className="mt-3 max-w-full md:w-[40%] text-center font-normal text-md">
